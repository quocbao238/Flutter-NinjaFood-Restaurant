...
class MapLocationPicker extends StatefulWidget {
  ...
  final String bottomCardHintText;

  final bool showButtonTypeMap;

  final bool showButtonLocation;
  ...
  const MapLocationPicker(
      ...
      this.bottomCardHintText = "Tap on map to get address",
      this.showButtonTypeMap = true,
...
class _MapLocationPickerState extends State<MapLocationPicker> {
  ...
  @override
  void initState() {
    _address = widget.bottomCardHintText;
