...
class CategoryItem extends StatelessWidget {
  ...
  const CategoryItem({Key? key, required this.onPressedMenu, required this.animation, required this.menuItem})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    final _menuImage = homeController.getImageUrlByProductId(menuItem.productIds![1]);
